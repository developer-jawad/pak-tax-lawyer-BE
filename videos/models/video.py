...
class Video(BaseModel):
    ...
    thumbnail = models.URLField(
        max_length=1000, blank=True, null=True, help_text="Thumbnail image URL"
    )
    duration = models.CharField(max_length=50, help_text="Video duration (e.g., 12:45)")
    views = models.CharField(
        max_length=50, blank=True, null=True, help_text="View count (e.g., 15.2K)"
    )
    ...
    video_url = models.URLField(
        max_length=1000, help_text="YouTube video URL or embed URL"
    )
