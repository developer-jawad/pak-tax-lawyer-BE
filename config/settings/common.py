"""
Django settings for PAK TAX LAWYER project.

Generated by 'django-admin startproject' using Django 4.1.2, but we are using Django 5.2.4.
...
ACCOUNT_LOGOUT_REDIRECT_URL = LOGIN_URL  # optional shortcut
...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": timedelta(days=10),  # TODO: Change to 1 day
...
# Cache — Postgres DatabaseCache backed by Supabase.
# Works on Vercel free (no Redis required). Run once to create the table:
...
# WhiteNoise: serve static files with compression and long-lived cache headers
STORAGES = {
    "staticfiles": {
