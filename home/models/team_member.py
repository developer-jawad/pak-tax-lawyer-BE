...
class TeamMember(BaseModel):
    ...
    specialization = models.CharField(
        max_length=255, help_text="Area of specialization"
    )
    avatar = models.ImageField(
        upload_to="team_members/", blank=True, null=True, help_text="Team member photo"
    )
    ...
    featured_label = models.CharField(
        max_length=50, blank=True, null=True, help_text="Label for featured members"
    )
