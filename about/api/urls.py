...
router.register(r'statistic-section', AboutStatisticSectionViewSet, basename='about-statistic-section')
router.register(r'statistic-items', AboutStatisticItemViewSet, basename='about-statistic-item')
